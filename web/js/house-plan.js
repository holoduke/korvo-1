...
window.HOUSE_PLAN = {
  ...
  openings: [
    ...
    /* the meter cupboard: the box in the hall beside the toilet, its door in
     * the box's side facing the hall (the kitchen end, away from the front door) */
    { key: "meterkast", sensor: "Meterkast", plane: "x", at: 3.9, a: 6.15, w: 0.8, y: 0, h: 2.1 },
